          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="tel" value={contact.phone_primary}
                onChange={e => setK('phone_primary', e.target.value)} className={inputClass} />
            </div>
            <div>
              <label className={labelClass}>Secondary phone</label>
              <input type="tel" value={contact.phone_secondary}
                onChange={e => setK('phone_secondary', e.target.value)} className={inputClass} />
            </div>
